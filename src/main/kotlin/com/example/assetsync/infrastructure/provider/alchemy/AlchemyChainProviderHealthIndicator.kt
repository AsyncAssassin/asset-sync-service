 ...
 * probe, DOWN after a failed fetch, with the scrubbed error. Details name the provider, the auth
 * mode, the probed networks, and the state; never an endpoint, a header, or the API key. Like the
 * HTTP indicator it stays out of the readiness group so a provider outage does not flap probes.
 */
